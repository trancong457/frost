...
<style type="text/css">
    ...
    #menu-portfolio-menu .menu-item-4 .title-taxonomy {
        color: #000;
    }
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-4 block-menu-sub-category">
                                                            ...
                                                            <li id="menu-item-<?php echo $value_port->ID; ?>"
                                                                ...
                                                                <a style="<?php echo $key == 0 ? 'color: #000' : ''; ?>"
                                                                   href="<?php echo get_the_permalink($value_port); ?>"><?php echo get_the_title($value_port->ID); ?></a>
                                                            </li>
                                                            <?php
                                                            if (($key + 1) % 3 == 0) {
                                                            ?>
