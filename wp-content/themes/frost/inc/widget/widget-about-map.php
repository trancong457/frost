...
function wpb_load_widget_about_map() {
    register_widget( 'Frost_about_map' );
}
add_action( 'widgets_init', 'wpb_load_widget_about_map' );

class Frost_about_map extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname' => 'Frost_about_map',
			'description' => 'Frost-About Map',
		);
		parent::__construct( 'Frost_about_map', 'Frost-About Map', $widget_ops );
	}
