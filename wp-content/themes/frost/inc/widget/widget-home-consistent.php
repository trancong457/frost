...
function wpb_load_widget_home_consistent() {
    register_widget( 'Frost_home_consistent' );
}
add_action( 'widgets_init', 'wpb_load_widget_home_consistent' );

class Frost_home_consistent extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname' => 'Frost_home_consistent',
			'description' => 'Frost-Home Consistent',
		);
		parent::__construct( 'Frost_home_consistent', 'Frost-Home Consistent', $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
        ...
        ?>
<section class="index-summary-consistent">
        <div class="container">
            <div class="col-12">
                <div class="row">
                    <h2 class="index-summary-consistent-title"><?php echo htmlspecialchars_decode($title); ?></h2>
                </div>
                <div class="row">
                    <div class="index-summary-consistent-summary"><?php echo $summary;  ?></div>
                </div>
                <div class="row">
                    <div class="col-12 col-md-7">
                        <div class="index-summary-consistent-des"><?php echo $content; ?></div>
                </div>
            </div>
        </div>
</section>
	...
	public function update( $new_instance, $old_instance ) {
        ...
        $instance['summary'] = ( ! empty( $new_instance['summary'] ) ) ? ( $new_instance['summary'] ) : '';
