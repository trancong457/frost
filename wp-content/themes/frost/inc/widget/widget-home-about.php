...
function wpb_load_widget_home_about() {
    register_widget( 'Frost_home_about' );
}
add_action( 'widgets_init', 'wpb_load_widget_home_about' );

class Frost_home_about extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname' => 'Frost_home_about',
			'description' => 'Frost-Home About',
		);
		parent::__construct( 'Frost_home_about', 'Frost-Home About', $widget_ops );
	}
...
<section class="index-summary-about">
        <div class="container">
            <div class="col-12">
                <div class="row">
                ...
                <div class="row">
                    <h2 class="index-about-title"><?php echo $title; ?></h2>
                </div>
                <div class="row">
                    <div class="index-about-des">
                    <?php echo $content; ?>
                    </div>
                </div>
            </div>
